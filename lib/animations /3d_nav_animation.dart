...
class Navigation3D extends StatefulWidget {
  const Navigation3D({super.key, required this.child, required this.drawer});

  final Widget child;
  final Widget drawer;
  @override
  State<Navigation3D> createState() => _Navigation3DState();
}

class _Navigation3DState extends State<Navigation3D> with TickerProviderStateMixin {
